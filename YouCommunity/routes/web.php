...
// ********************************************************************************************************
Route::middleware('auth')->group(function () {
    Route::get('/myInvitation', [InvitationController::class, 'show'])->name('my.invitation');
    Route::get('/event/{event}/inviterUser', [InvitationController::class, 'index'])->name('event.show.inviter');
    Route::post('/event/{event}/inviter', [InvitationController::class, 'store'])->name('event.inviter');
    Route::get('/event/{event}/invitation', [InvitationController::class, 'showAll'])->name('event.show.invitations');
    Route::post('/event/{event}/invitation/status', [InvitationController::class, 'statusInv'])->name('event.invitation.status');
